 ...
 */
public class FragmentComicHistory extends Fragment{
    private List<ComicHistory> comicHistoryList;
    ...
    public void getComicHistory(){
        comicHistoryList= DataSupport.order("id desc").find(ComicHistory.class);
        if(myAdapter==null){
            myAdapter=new MyAdapter(comicHistoryList);
            recyclerView.setAdapter(myAdapter);
        }
        else {
            myAdapter.setData(comicHistoryList);
    ...
    class MyAdapter extends RecyclerView.Adapter {
        ...
        private List<ComicHistory> data;
